...
public class DeathCrownCommand implements CommandExecutor, TabCompleter {
    ...
    private void sendHelp(CommandSender sender) {
        sender.sendMessage("§8=== §4破碎王冠管理 §8===");
        sender.sendMessage("§6/deathcrown give §7- 给自己破碎王冠");
        sender.sendMessage("§6/deathcrown give <玩家> §7- 给指定玩家破碎王冠");
    ...
    private void handleGive(CommandSender sender, String[] args) {
        if (!sender.hasPermission("deathcrown.give")) {
            sender.sendMessage("§c❌ 你没有权限给予破碎王冠");
            return;
        }
        ...
        if (!targetPlayer.equals(sender)) {
            sender.sendMessage("§a✅ 已给予 §4" + targetPlayer.getName() + " §a破碎王冠");
        }
    }
    ...
    private void handleReset(CommandSender sender, String[] args) {
        ...
        if (args.length == 1) {
            ...
            if (sender instanceof Player) {
                ...
                sender.sendMessage("§a✅ 已重置世界 §e" + world.getName() + " §a的破碎王冠使用状态");
            } else {
            ...
            if (args[1].equalsIgnoreCase("all")) {
                ...
                sender.sendMessage("§a✅ 已重置所有世界的破碎王冠使用状态");
            } else {
                // 重置指定世界
    ...
    private void handleStatus(CommandSender sender) {
        ...
        sender.sendMessage("§8=== §4破碎王冠状态 §8===");
    ...
    private void handleReload(CommandSender sender) {
        ...
        sender.sendMessage("§a✅ 破碎王冠配置已重载");
    }
